...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para Mariam:\n\nHola mi niña , Desde q te vi,senti una conexion contigo tambien senti en ese momento q tu eras mi chica indicada lit , eres muy importante para mi mariam,MI NIÑA BONITA :) te tengo demasiado cariño , se q no lo demuestro en persona pero , es hora de arriesgar y mostrarlo si o si , porq si no te aburrire jeje, te quiero, te amo tmbien jeje  si :3 te mando besitos, aa y gracias a tu mami , q pudo traer al mundo al amor de mi vida , siempre te lo dire mariam , te quierooooo muchooooo, mi niña bonita , asi estemos en pareja, cada dia t lo hare saber muak :)`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Carlos";
...
function showCountdown() {
  ...
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('4010-12-30T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Proximo detalle en: <b>${days}</b> días<br>` +
      `Cuando el numero llegue  a 0 te dejare de amar :): <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
